...
import com.android.carserve.ui.notifications.NotificationsFragment;
...
public class PackageAdapter2 extends RecyclerView.Adapter<PackageAdapter2.MyViewHolder> {
    ...
    public PackageAdapter2(ArrayList<packagedata> al, NotificationsFragment context) {
        this.al = al;
    ...
    @Override
    public PackageAdapter2.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(PackageAdapter2.MyViewHolder holder, final int position) {
