...
import com.android.carserve.ui.dashboard.DashboardFragment;
...
public class PackageAdapter1 extends RecyclerView.Adapter<PackageAdapter1.MyViewHolder> {

    ArrayList<packagedata> al;
    DashboardFragment context;

    public PackageAdapter1(ArrayList<packagedata> al, DashboardFragment context) {
        this.al = al;
    ...
    @Override
    public PackageAdapter1.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(PackageAdapter1.MyViewHolder holder, final int position) {
